...
static inline S Lerp(const S& a, const S& b, T factor)
{
    return (1 - factor) * a + factor * b;
}

template <typename S, typename T>
static inline S Bilerp(const S& x00, const S& x10, const S& x01, const S& x11, T factorX, T factorY)     
{
    return Lerp(Lerp(x00, x10, factorX), Lerp(x01, x11, factorX), factorY);
}  

template <typename S, typename T>
static inline S Trilerp(const S& x000, const S& x100, const S& x010, const S& x110, const S& x001, const S& x101, const S& x011, const S& x111, T factorX, T factorY, T factorZ)     
{
